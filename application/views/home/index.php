...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?php echo base_url("assets/template/arsha/") ?>assets/css/style.css" rel="stylesheet">
...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#structure">Structure</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/hero-img.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container P-5">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-1.png" class="img-fluid" alt=""> -->
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-2.png" class="img-fluid" alt=""> -->
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-3.png" class="img-fluid" alt=""> -->
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-4.png" class="img-fluid" alt=""> -->
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-5.png" class="img-fluid" alt=""> -->
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <!-- <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/clients/client-6.png" class="img-fluid" alt=""> -->
          </div>
              ...
              <ul>
                <li>
                  ...
                  <!-- <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list"> -->
                    <p>
                      <span>01</span> Mewujudkan HIMANIKA sebagai suatu media pembelajaran yang mencerdaskan mahasiswa dan menciptakan suatu kenyamanan dalam Program Studi manajemen Informatika
                    </p>
                  <!-- </div> -->
                </li>
                ...
                <li>
                  ...
                  <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list"> -->
                    <p>
                      <span>02</span> Menjadikan HIMANIKA sebagai fasilitator kepada mahasiswa untuk berpartisipasi dalam berbagai kegiatan atau hal positif
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div class="accordion-list">
              <ul>
                <li>
                  ...
                  <!-- <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list"> -->
                    <p>
                    <span>01</span> Mengadakan pelatihan yang mendukung peningkatan pengetahuan dan skill dari setiap mahasiswa
                    </p>
                  <!-- </div> -->
                </li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
            <img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/skills.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/team/team-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/team/team-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/team/team-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
              <div class="pic"><img src="<?php echo base_url("assets/template/arsha/") ?>assets/img/team/team-4.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/aos/aos.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/waypoints/noframework.waypoints.js"></script>
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo base_url("assets/template/arsha/") ?>assets/js/main.js"></script>
