...
<head>
	...
	<link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap/css/bootstrap.min.css"
		rel="stylesheet">
	<link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap-icons/bootstrap-icons.css"
		rel="stylesheet">
	<link href="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/boxicons/css/boxicons.min.css"
		rel="stylesheet">
...
<body>
	...
	<main id="main">
      ...
      <div class="container" data-aos="fade-up">
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-kominfo">
						<div class="portfolio-img"><img
								src="<?php echo base_url("assets/template/arsha/") ?>assets/img/portfolio/kominfo1.jpeg"
								class="img-fluid" alt=""></div>
						<div class="portfolio-info">
		...
		<!-- ======= Activity Section ======= -->
		<section id="agenda" class="portfolio">
			<div class="container" data-aos="fade-up">

				<div class="section-title">
					<h2>Agenda Kegiatan HIMANIKA Yang Masih Berjalan</h2>
					<p>Informasi Himpunan Mahasiswa Manajemen Informatika Yang masih berjalan</p>
				</div>

				<ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
					<li data-filter="*" class="filter-active">All</li>
					<li data-filter=".filter-humas_agenda">Humas</li>
					<li data-filter=".filter-psdm_agenda">PSDM</li>
					<li data-filter=".filter-kominfo_agenda">Kominfo</li>
				</ul>

				<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">

					<div class="col-lg-4 col-md-6 portfolio-item filter-psdm_agenda">
						<div class="portfolio-img"><img
								src="<?php echo base_url("assets/template/arsha/") ?>assets/img/portfolio/psdm4.jpeg" class="img-fluid"
								alt="">
							<h4>Divisi PSDM</h4>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-kominfo_agenda">
						<div class="portfolio-img"><img
								src="<?php echo base_url("assets/template/arsha/") ?>assets/img/portfolio/kominfo1.jpeg"
								class="img-fluid" alt="">
							<h4>Divisi Kominfo</h4>
	...
	<script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js">
	</script>
	<script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/glightbox/js/glightbox.min.js"></script>
	<script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/isotope-layout/isotope.pkgd.min.js">
	</script>
	<script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/swiper/swiper-bundle.min.js"></script>
	<script src="<?php echo base_url("assets/template/arsha/") ?>assets/vendor/waypoints/noframework.waypoints.js">
	</script>
